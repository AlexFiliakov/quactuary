...
.. toctree::
   :maxdepth: 2
   :caption: Contributing to quactuary
...
1. **Browse Issues**: Check out `open issues <https://github.com/AlexFiliakov/quactuary/issues>`_ to find something that interests you
2. **Fork & Clone**: Fork the repository and clone your fork locally
3. **Set Up Environment**: Follow our :doc:`setting_up_environment` guide
...
* **GitHub Issues**: Ask questions on our `issue tracker <https://github.com/AlexFiliakov/quactuary/issues>`_
* **Documentation**: Check our comprehensive docs at `docs.quactuary.com <https://docs.quactuary.com>`_
